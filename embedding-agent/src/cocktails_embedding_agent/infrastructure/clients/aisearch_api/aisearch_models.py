...
#   timestamp: 2026-05-19T00:51:04+00:00
...
class CocktailSearchIngredientTypeModel(Enum):
    """
...
class CocktailSearchIngredientModel(BaseModel):
    ...
    uoM: CocktailSearchUofMTypeModel = Field(
        ..., description='Unit of Measure for the ingredient', examples=['ounces']
    )
    ...
    units: float = Field(
        ..., description='Quantity of the ingredient', examples=[1.5], title='Units'
    )
...
class CocktailSearchStatistics(BaseModel):
    ...
    hitCount: Optional[int] = Field(
        0, description='Number of matching chunks', examples=[3], title='Hitcount'
    )
...
class CocktailEmbeddingModel(BaseModel):
    ...
    rating: float = Field(
        ..., description='Rating of the cocktail', examples=[4.5], title='Rating'
    )
    ...
    serves: int = Field(
        ..., description='Number of servings', examples=[1], title='Serves'
    )
    ...
    searchTiles: List[str] = Field(
        ...
        examples=[
            ['http://localhost:7179/api/v1/images/old-fashioned-cocktail-300x300.webp']
        ],
        title='Searchtiles',
    )
...
class CocktailSearchModel(BaseModel):
    ...
    searchStatistics: Optional[CocktailSearchStatistics] = Field(
